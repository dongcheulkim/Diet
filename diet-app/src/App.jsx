...
중요: 사용자가 음식을 먹었다고 말하거나, 물을 마셨다고 말하거나, 운동을 했다고 말하면,
응답의 맨 마지막에 아래 JSON 형식으로 기록할 데이터를 추가해주세요:
\`\`\`auto_record
{"food":[{"name":"음식이름","cal":추정칼로리}],"water":마신ml수,"exercise":["운동내용"]}
\`\`\`
- food: 먹었다고 한 음식 목록 (칼로리는 한국 기준으로 추정)
- water: 물/음료를 마셨다고 하면 ml 단위 (컵=200ml, 병=500ml)
- exercise: 운동을 했다고 하면 운동 내용
- 해당 없는 항목은 빈 배열이나 0으로`;
