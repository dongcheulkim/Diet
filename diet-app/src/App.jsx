...
// ── 한국 음식 칼로리 DB (1인분 기준, 식약처/필라이즈/팻시크릿 참고) ──
const FOOD_DB = {
  // 밥류 (1공기 210g)
  "밥":300,"공기밥":300,"흰쌀밥":300,"현미밥":310,"잡곡밥":310,
  // 찌개/국류 (1인분, 밥 제외)
  "김치찌개":230,"된장찌개":180,"순두부찌개":220,"부대찌개":380,
  // 면류
  ...
  // 고기 (1인분 200g)
  "삼겹살":660,"목살":530,"갈비":540,"불고기":400,
  // 치킨 (반마리 기준)
  "치킨":900,"후라이드치킨":900,"양념치킨":1050,"반반치킨":970,"치킨 한마리":1800,
  // 피자
  "피자":2500,"피자 한조각":300,"피자 한판":2500,
  // 버거
  "햄버거":500,"빅맥":520,"치즈버거":400,
  // 한식 밥류 (밥 포함 1인분)
  "비빔밥":650,"돌솥비빔밥":590,
  "제육볶음":490,"김치볶음밥":500,"볶음밥":480,
  "돈까스":800,"돈가스":800,"치킨까스":700,
  // 면류 (1인분)
  "냉면":460,"물냉면":430,"비빔냉면":480,
  "칼국수":420,"수제비":380,"잔치국수":350,
  // 탕류 (밥 제외 1인분)
  "삼계탕":580,"설렁탕":500,"갈비탕":500,"육개장":500,
  // 재료/간식 (1개 또는 100g)
  ...
  // 주류 (1병/1캔)
  "맥주":200,"소주":400,"막걸리":300,
  // 베이커리 (1개)
  "떡":250,"빵":280,"식빵":180,"크로와상":300,"도넛":300,
  "과자":200,"초콜릿":250,"아이스크림":200,"케이크":350,
  // 브랜드 과자 (1봉지 기준)
  "포카칩":377,"새우깡":465,"꼬깔콘":385,"허니버터칩":340,
  "프링글스":600,"양파링":375,"치토스":530,"오징어집":285,"오감자":300,
  "꼬북칩":300,"스윙칩":370,"에이스":250,"칙촉":200,
  // 브랜드 초코/쿠키 (1봉지/1상자/1개)
  "빼빼로":270,"초코파이":150,"오예스":126,"몽쉘":130,
  "홈런볼":270,"칸쵸":200,"마가렛트":230,"다이제":200,
  "오레오":250,"빈츠":200,"촉촉한초코칩":200,
  // 브랜드 초콜릿 (1개/1갑)
  "가나초콜릿":185,"크런키":185,"ABC초콜릿":30,
  "페레로로쉐":75,"킨더부에노":120,"킨더초콜릿":55,
  "드림카카오":200,"키세스":22,"엠앤엠즈":230,
  // 젤리/캔디 (1봉지)
  "하리보":340,"하리보젤리":340,"곰젤리":340,"골드베렌":340,
  "마이구미":170,"젤리밤":200,"왕꿈틀이":200,
  "새콤달콤":130,"츄파춥스":50,"멘토스":150,
  "자일리톨":5,"목캔디":15,
  // 브랜드 아이스크림 (1개)
  "메로나":120,"비비빅":135,"월드콘":270,"부라보콘":280,
  "돼지바":175,"스크류바":92,"바밤바":100,"수박바":100,
  "누가바":140,"쿠앤크":234,"구구콘":300,"아맛나":115,
  "탱크보이":90,"폴라포":80,"쮸쮸바":80,"빠삐코":130,
  "하겐다즈":250,"설레임":160,"투게더":200,
  // 편의점/길거리 간식 (1개)
  "삼각김밥":200,"핫바":200,"붕어빵":120,"호떡":250,
  "호빵":200,"떡꼬치":140,"어묵":80,"소시지":180,
  "컵누들":120,"컵밥":350,
  // 야식/외식 (1인분)
  "족발":800,"보쌈":800,"쌈밥":400,
  "짜장면":750,"짬뽕":700,"탕수육":480,
  "초밥":400,"회":200,"연어":200,"참치":150,
  "토스트":300,"샌드위치":350,
  "국밥":550,"순대국":500,"감자탕":800,
  "파스타":550,"스파게티":550,"카르보나라":700,"크림파스타":680,
  "스테이크":500,"리조또":500,
  "만두":350,"군만두":480,"물만두":280,
